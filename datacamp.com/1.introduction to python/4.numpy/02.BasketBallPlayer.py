...
You are a huge baseball fan. You decide to call the MLB (Major League Baseball) and
ask around for some more statistics on the height of the main players.
...
import numpy as np
height_in = [1.8796, 1.8796, 1.8288, 1.905,  1.905, 1.8542]
print(height_in)
# Import numpy
